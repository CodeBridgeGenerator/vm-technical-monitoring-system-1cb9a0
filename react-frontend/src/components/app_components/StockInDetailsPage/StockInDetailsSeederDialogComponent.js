...
import seederData from "./stockInDetails.seeder.json";
...
const StockInDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(StockInDetailsSeederDialogComponent);
