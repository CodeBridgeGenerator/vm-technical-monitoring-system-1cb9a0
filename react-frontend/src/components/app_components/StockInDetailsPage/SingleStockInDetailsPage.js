...
const SingleStockInDetailsPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleStockInDetailsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
        ...
        setWarehouse(warehouse);
            ...
            .catch((error) => {
                console.log({ error });
                props.alert({ title: "StockInDetails", type: "error", message: error.message || "Failed get stockInDetails" });
            });
    }, [props,urlParams.singleStockInDetailsId]);


    const goBack = () => {
        navigate("/app/stockInDetails");
    };
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Stock-In Details</h3>
                    <SplitButton
                ...
                {/* <p>stockInDetails/{urlParams.singleStockInDetailsId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Part No</label><p className="m-0 ml-3" >{_entity?.partNo}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Purchase Date</label><p id="purchaseDate" className="m-0 ml-3" >{_entity?.purchaseDate}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Condition of Terms</label><p className="m-0 ml-3" >{_entity?.conditionOfTerms}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleStockInDetailsId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleStockInDetailsPage);
