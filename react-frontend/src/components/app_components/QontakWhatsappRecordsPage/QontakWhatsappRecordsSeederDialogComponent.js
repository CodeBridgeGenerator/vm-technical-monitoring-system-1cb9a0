...
import seederData from "./qontakWhatsappRecords.seeder.json";
...
const QontakWhatsappRecordsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(QontakWhatsappRecordsSeederDialogComponent);
