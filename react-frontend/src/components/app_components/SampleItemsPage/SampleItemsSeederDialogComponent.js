...
import seederData from "./sampleItems.seeder.json";
...
const SampleItemsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(SampleItemsSeederDialogComponent);
