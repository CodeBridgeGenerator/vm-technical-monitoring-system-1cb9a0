...
import seederData from "./operationCentres.seeder.json";
...
const OperationCentresSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(OperationCentresSeederDialogComponent);
