...
import seederData from "./sampleDetails.seeder.json";
...
const SampleDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(SampleDetailsSeederDialogComponent);
