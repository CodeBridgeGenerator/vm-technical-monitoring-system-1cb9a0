...
const CustomerSalesOrdersEditDialogComponent = (props) => {
...
salesOrderDate: _entity?.salesOrderDate,
        };

        setLoading(true);
        try {
            
        await client.service("customerSalesOrders").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info customerSalesOrders updated successfully" });
    ...
    return (
        <Dialog header="Edit Sales Orders" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="customerSalesOrders-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(CustomerSalesOrdersEditDialogComponent);
