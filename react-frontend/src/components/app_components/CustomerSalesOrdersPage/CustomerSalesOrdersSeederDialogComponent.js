...
import seederData from "./customerSalesOrders.seeder.json";
...
const CustomerSalesOrdersSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CustomerSalesOrdersSeederDialogComponent);
