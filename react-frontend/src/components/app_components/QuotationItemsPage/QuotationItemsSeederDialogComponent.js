...
import seederData from "./quotationItems.seeder.json";
...
const QuotationItemsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(QuotationItemsSeederDialogComponent);
