...
import seederData from "./externalChecks.seeder.json";
...
const ExternalChecksSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ExternalChecksSeederDialogComponent);
