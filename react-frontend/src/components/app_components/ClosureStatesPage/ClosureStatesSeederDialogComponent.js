...
import seederData from "./closureStates.seeder.json";
...
const ClosureStatesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ClosureStatesSeederDialogComponent);
