...
import seederData from "./atlasChecklists.seeder.json";
...
const AtlasChecklistsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(AtlasChecklistsSeederDialogComponent);
