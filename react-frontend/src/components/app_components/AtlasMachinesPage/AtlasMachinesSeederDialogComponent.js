...
import seederData from "./atlasMachines.seeder.json";
...
const AtlasMachinesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(AtlasMachinesSeederDialogComponent);
