...
import seederData from "./deliveryOrderItems.seeder.json";
...
const DeliveryOrderItemsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(DeliveryOrderItemsSeederDialogComponent);
