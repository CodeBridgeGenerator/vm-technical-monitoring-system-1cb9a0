...
import seederData from "./atlasTickets.seeder.json";
...
const AtlasTicketsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(AtlasTicketsSeederDialogComponent);
