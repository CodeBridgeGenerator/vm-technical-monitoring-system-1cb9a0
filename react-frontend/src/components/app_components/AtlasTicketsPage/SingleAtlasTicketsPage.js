...
const SingleAtlasTicketsPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleAtlasTicketsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
        ...
        setMachineId(machineId);
            ...
            .catch((error) => {
                console.log({ error });
                props.alert({ title: "AtlasTickets", type: "error", message: error.message || "Failed get atlasTickets" });
            });
    }, [props,urlParams.singleAtlasTicketsId]);


    const goBack = () => {
        navigate("/app/atlasTickets");
    };
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Atlas Tickets</h3>
                    <SplitButton
                ...
                {/* <p>atlasTickets/{urlParams.singleAtlasTicketsId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">End Time</label><p className="m-0 ml-3" ><Calendar id="endTime" value={new Date(_entity?.endTime)} disabled={true} hourFormat="12"   /></p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleAtlasTicketsId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleAtlasTicketsPage);
