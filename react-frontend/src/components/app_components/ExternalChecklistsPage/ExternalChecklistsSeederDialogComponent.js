...
import seederData from "./externalChecklists.seeder.json";
...
const ExternalChecklistsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ExternalChecklistsSeederDialogComponent);
