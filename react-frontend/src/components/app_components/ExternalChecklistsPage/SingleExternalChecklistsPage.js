...
const SingleExternalChecklistsPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleExternalChecklistsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleExternalChecklistsId]);


    const goBack = () => {
        navigate("/app/externalChecklists");
    };
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">External Checklists</h3>
                    <SplitButton
                ...
                {/* <p>externalChecklists/{urlParams.singleExternalChecklistsId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Description</label><p className="m-0 ml-3" >{_entity?.description}</p></div>
    ...
    <div className="col-12 mt-2">
        <TabView>
                    ...
                    <TabPanel header="External Checks" leftIcon="pi pi-building-columns mr-2">
                        <ExternalChecksPage/>
                    </TabPanel>
                    

                    <TabPanel header="Supervisor Checks" leftIcon="pi pi-building-columns mr-2">
      ...
      <CommentsSection
        recordId={urlParams.singleExternalChecklistsId}
        user={props.user}
        alert={props.alert}
        serviceName="externalChecklists"
      />
      <div
        id="rightsidebar"
...
export default connect(mapState, mapDispatch)(SingleExternalChecklistsPage);
