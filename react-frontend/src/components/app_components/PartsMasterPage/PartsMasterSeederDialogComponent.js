...
import seederData from "./partsMaster.seeder.json";
...
const PartsMasterSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PartsMasterSeederDialogComponent);
