...
import seederData from "./memStockOutDetails.seeder.json";
...
const MemStockOutDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MemStockOutDetailsSeederDialogComponent);
