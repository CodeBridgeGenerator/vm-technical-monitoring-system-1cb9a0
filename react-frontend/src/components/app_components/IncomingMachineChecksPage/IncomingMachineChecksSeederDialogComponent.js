...
import seederData from "./incomingMachineChecks.seeder.json";
...
const IncomingMachineChecksSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(IncomingMachineChecksSeederDialogComponent);
