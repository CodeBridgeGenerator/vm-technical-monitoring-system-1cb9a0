...
import seederData from "./machineMaster.seeder.json";
...
const MachineMasterSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MachineMasterSeederDialogComponent);
