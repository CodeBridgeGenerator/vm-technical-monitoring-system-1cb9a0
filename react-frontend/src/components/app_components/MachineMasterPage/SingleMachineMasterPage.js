...
const [vendingMachineType, setVendingMachineType] = useState([]);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleMachineMasterId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Machine Master</h3>
                    <SplitButton
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">VendingMachineCode</label><p className="m-0 ml-3" >{_entity?.vendingMachineCode}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Serial Number</label><p className="m-0 ml-3" >{Number(_entity?.serialNumber)}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Comission Date</label><p id="comissionDate" className="m-0 ml-3" >{_entity?.comissionDate}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">VendingMachineType</label>
    ...
    <div className="col-12 mt-2">
        <TabView>
                    ...
                    <TabPanel header="External Tickets" leftIcon="pi pi-building-columns mr-2">
                        <ExternalTicketsPage/>
                    </TabPanel>
                    

                    <TabPanel header="Atlas Tickets" leftIcon="pi pi-building-columns mr-2">
                        <AtlasTicketsPage/>
                    </TabPanel>
                    

                    <TabPanel header="Incoming Machine Tickets" leftIcon="pi pi-building-columns mr-2">
                        <IncomingMachineTicketsPage/>
                    </TabPanel>
                    

                    <TabPanel header="Incoming Machine Abort History" leftIcon="pi pi-building-columns mr-2">
                        <IncomingMachineAbortHistoryPage/>
                    </TabPanel>
                    

                    <TabPanel header="Etika Tickets" leftIcon="pi pi-building-columns mr-2">
                        <EtikaTicketsPage/>
                    </TabPanel>
      ...
      <CommentsSection
        recordId={urlParams.singleMachineMasterId}
        user={props.user}
        alert={props.alert}
