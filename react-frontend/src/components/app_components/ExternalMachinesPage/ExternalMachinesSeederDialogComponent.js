...
import seederData from "./externalMachines.seeder.json";
...
const ExternalMachinesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ExternalMachinesSeederDialogComponent);
