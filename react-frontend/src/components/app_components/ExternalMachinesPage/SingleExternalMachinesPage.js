...
const SingleExternalMachinesPage = (props) => {
...
const [vendingMachineType, setVendingMachineType] = useState([]);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleExternalMachinesId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
...
const vendingMachineType = Array.isArray(res.vendingMachineType)
        ...
        setVendingMachineType(vendingMachineType);
            ...
            .catch((error) => {
                console.log({ error });
                props.alert({ title: "ExternalMachines", type: "error", message: error.message || "Failed get externalMachines" });
            });
    }, [props,urlParams.singleExternalMachinesId]);


    const goBack = () => {
        navigate("/app/externalMachines");
    };
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">External Machines</h3>
                    <SplitButton
                ...
                {/* <p>externalMachines/{urlParams.singleExternalMachinesId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Vending Machine Type</label>
      ...
      <CommentsSection
        recordId={urlParams.singleExternalMachinesId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleExternalMachinesPage);
