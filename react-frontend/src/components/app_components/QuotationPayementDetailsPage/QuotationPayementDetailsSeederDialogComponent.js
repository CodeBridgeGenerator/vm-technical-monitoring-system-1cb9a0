...
import seederData from "./quotationPayementDetails.seeder.json";
...
const QuotationPayementDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(QuotationPayementDetailsSeederDialogComponent);
