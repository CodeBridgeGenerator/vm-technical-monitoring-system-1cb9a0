...
const SingleQuotationPayementDetailsPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleQuotationPayementDetailsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleQuotationPayementDetailsId]);


    const goBack = () => {
        navigate("/app/quotationPayementDetails");
    };
  ...
  const copyPageLink = () => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">QuotationPayementDetails</h3>
                    <SplitButton
                ...
                {/* <p>quotationPayementDetails/{urlParams.singleQuotationPayementDetailsId}</p> */}
            </div>
      ...
      <CommentsSection
        recordId={urlParams.singleQuotationPayementDetailsId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleQuotationPayementDetailsPage);
