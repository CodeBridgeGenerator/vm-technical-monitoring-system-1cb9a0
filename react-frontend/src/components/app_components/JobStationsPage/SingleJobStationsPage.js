...
const SingleJobStationsPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("jobStations")
            .get(urlParams.singleJobStationsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleJobStationsId]);


    const goBack = () => {
        navigate("/app/jobStations");
    };
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Job Stations</h3>
                    <SplitButton
                ...
                {/* <p>jobStations/{urlParams.singleJobStationsId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Description</label><p className="m-0 ml-3" >{_entity?.description}</p></div>
    ...
    <div className="col-12 mt-2">
      ...
      <CommentsSection
        recordId={urlParams.singleJobStationsId}
        user={props.user}
        alert={props.alert}
        serviceName="jobStations"
      />
      <div
        id="rightsidebar"
...
export default connect(mapState, mapDispatch)(SingleJobStationsPage);
