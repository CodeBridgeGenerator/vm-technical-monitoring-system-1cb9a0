...
import seederData from "./jobStations.seeder.json";
...
const JobStationsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(JobStationsSeederDialogComponent);
