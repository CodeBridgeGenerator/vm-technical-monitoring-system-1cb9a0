...
const SingleVendingMachinesPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleVendingMachinesId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleVendingMachinesId]);


    const goBack = () => {
        navigate("/app/vendingMachines");
    };
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Vending Machines</h3>
                    <SplitButton
                ...
                {/* <p>vendingMachines/{urlParams.singleVendingMachinesId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Description</label><p className="m-0 ml-3" >{_entity?.description}</p></div>
    ...
    <div className="col-12 mt-2">
        <TabView>
                    ...
                    <TabPanel header="Machine Master" leftIcon="pi pi-building-columns mr-2">
                        <MachineMasterPage/>
                    </TabPanel>
                    

                    <TabPanel header="Atlas Machines" leftIcon="pi pi-building-columns mr-2">
                        <AtlasMachinesPage/>
                    </TabPanel>
                    

                    <TabPanel header="Mem Machines" leftIcon="pi pi-building-columns mr-2">
                        <MemMachinesPage/>
                    </TabPanel>
                    

                    <TabPanel header="External Machines" leftIcon="pi pi-building-columns mr-2">
                        <ExternalMachinesPage/>
                    </TabPanel>
                    

                    <TabPanel header="Irms Machines" leftIcon="pi pi-building-columns mr-2">
                        <IrmsMachinesPage/>
                    </TabPanel>
      ...
      <CommentsSection
        recordId={urlParams.singleVendingMachinesId}
        user={props.user}
        alert={props.alert}
        serviceName="vendingMachines"
      />
      <div
        id="rightsidebar"
...
export default connect(mapState, mapDispatch)(SingleVendingMachinesPage);
