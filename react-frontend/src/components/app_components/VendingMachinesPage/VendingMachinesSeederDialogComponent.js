...
import seederData from "./vendingMachines.seeder.json";
...
const VendingMachinesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(VendingMachinesSeederDialogComponent);
