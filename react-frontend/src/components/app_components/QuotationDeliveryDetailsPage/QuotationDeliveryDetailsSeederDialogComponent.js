...
import seederData from "./quotationDeliveryDetails.seeder.json";
...
const QuotationDeliveryDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(QuotationDeliveryDetailsSeederDialogComponent);
