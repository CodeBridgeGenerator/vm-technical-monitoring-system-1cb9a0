...
import seederData from "./technicianChecks.seeder.json";
...
const TechnicianChecksSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TechnicianChecksSeederDialogComponent);
