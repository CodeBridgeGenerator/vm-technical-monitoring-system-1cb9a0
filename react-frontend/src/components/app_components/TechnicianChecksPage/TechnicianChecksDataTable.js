...
const TechnicianChecksDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
...
const dropdownTemplate0 = (rowData, { rowIndex }) => <p >{rowData.technicianCheckListId?.name}</p>
...
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.description}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="technicianCheckListId" header="Technician Check List Id" body={dropdownTemplate0} filter={selectedFilterFields.includes("technicianCheckListId")} hidden={selectedHideFields?.includes("technicianCheckListId")}  style={{ minWidth: "8rem" }} />
...
<Column field="description" header="Description" body={pTemplate2} filter={selectedFilterFields.includes("description")} hidden={selectedHideFields?.includes("description")}  sortable style={{ minWidth: "8rem" }} />
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload TechnicianChecks Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
      ...
      <Dialog header="Search TechnicianChecks" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
...
export default TechnicianChecksDataTable;