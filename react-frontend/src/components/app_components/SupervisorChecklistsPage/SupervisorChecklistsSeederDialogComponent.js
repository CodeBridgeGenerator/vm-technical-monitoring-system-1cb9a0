...
import seederData from "./supervisorChecklists.seeder.json";
...
const SupervisorChecklistsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(SupervisorChecklistsSeederDialogComponent);
