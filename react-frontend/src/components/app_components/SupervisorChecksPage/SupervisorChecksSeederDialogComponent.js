...
import seederData from "./supervisorChecks.seeder.json";
...
const SupervisorChecksSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(SupervisorChecksSeederDialogComponent);
