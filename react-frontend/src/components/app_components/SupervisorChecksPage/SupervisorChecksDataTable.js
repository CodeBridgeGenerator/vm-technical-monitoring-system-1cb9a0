...
const SupervisorChecksDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
...
const dropdownTemplate0 = (rowData, { rowIndex }) => <p >{rowData.supervisorCheckListId?.name}</p>
...
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.description}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="supervisorCheckListId" header="Supervisor Check List Id" body={dropdownTemplate0} filter={selectedFilterFields.includes("supervisorCheckListId")} hidden={selectedHideFields?.includes("supervisorCheckListId")}  style={{ minWidth: "8rem" }} />
...
<Column field="description" header="Description" body={pTemplate2} filter={selectedFilterFields.includes("description")} hidden={selectedHideFields?.includes("description")}  sortable style={{ minWidth: "8rem" }} />
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload SupervisorChecks Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
      ...
      <Dialog header="Search SupervisorChecks" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
...
export default SupervisorChecksDataTable;