...
const SupervisorChecksEditDialogComponent = (props) => {
    ...
    const onSave = async () => {
        let _data = {
            supervisorCheckListId: _entity?.supervisorCheckListId?._id,
name: _entity?.name,
description: _entity?.description,
        ...
        await client.service("supervisorChecks").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info supervisorChecks updated successfully" });
    ...
    return (
        <Dialog header="Edit Supervisor Checks" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="supervisorChecks-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(SupervisorChecksEditDialogComponent);
