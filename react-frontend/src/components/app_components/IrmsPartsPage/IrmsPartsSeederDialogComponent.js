...
import seederData from "./irmsParts.seeder.json";
...
const IrmsPartsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(IrmsPartsSeederDialogComponent);
