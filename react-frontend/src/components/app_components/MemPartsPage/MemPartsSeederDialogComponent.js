...
import seederData from "./memParts.seeder.json";
...
const MemPartsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MemPartsSeederDialogComponent);
