...
import seederData from "./memWarehouses.seeder.json";
...
const MemWarehousesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MemWarehousesSeederDialogComponent);
