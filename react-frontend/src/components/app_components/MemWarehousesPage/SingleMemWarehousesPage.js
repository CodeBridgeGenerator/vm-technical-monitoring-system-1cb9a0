...
const SingleMemWarehousesPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleMemWarehousesId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleMemWarehousesId]);


    const goBack = () => {
        navigate("/app/memWarehouses");
    };
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Mem Warehouses</h3>
                    <SplitButton
                ...
                {/* <p>memWarehouses/{urlParams.singleMemWarehousesId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Locataion</label><p className="m-0 ml-3" >{_entity?.locataion}</p></div>
    ...
    <div className="col-12 mt-2">
        <TabView>
                    ...
                    <TabPanel header="Mem Stock In Details" leftIcon="pi pi-building-columns mr-2">
                        <MemStockInDetailsPage/>
                    </TabPanel>
                    

                    <TabPanel header="Mem Transfer Details" leftIcon="pi pi-building-columns mr-2">
      ...
      <CommentsSection
        recordId={urlParams.singleMemWarehousesId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleMemWarehousesPage);
