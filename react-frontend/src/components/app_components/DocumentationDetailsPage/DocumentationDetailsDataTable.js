...
<Column field="documentationFile" header="Documentation File" body={dropdownTemplate1} filter={selectedFilterFields.includes("documentationFile")} hidden={selectedHideFields?.includes("documentationFile")}  style={{ minWidth: "8rem" }} />
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload DocumentationDetails Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
      ...
      <Dialog header="Search DocumentationDetails" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
