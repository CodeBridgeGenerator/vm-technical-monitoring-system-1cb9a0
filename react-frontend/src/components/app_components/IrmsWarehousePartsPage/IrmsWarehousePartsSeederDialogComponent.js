...
import seederData from "./irmsWarehouseParts.seeder.json";
...
const IrmsWarehousePartsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(IrmsWarehousePartsSeederDialogComponent);
