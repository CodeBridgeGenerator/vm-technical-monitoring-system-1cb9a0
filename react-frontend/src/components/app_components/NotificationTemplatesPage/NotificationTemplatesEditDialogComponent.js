...
const NotificationTemplatesEditDialogComponent = (props) => {
...
image: _entity?.image,
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info notificationTemplates updated successfully" });
    ...
    return (
        <Dialog header="Edit Notification Templates" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            ...
            style={{ maxWidth: "55vw" }} role="notificationTemplates-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(NotificationTemplatesEditDialogComponent);
