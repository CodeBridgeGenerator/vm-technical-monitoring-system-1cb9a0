...
const MemTransferDetailsEditDialogComponent = (props) => {
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="transferDate" value={_entity?.transferDate ? new Date(_entity?.transferDate) : null} onChange={ (e) => setValByKey("transferDate", new Date(e.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
...
export default connect(mapState, mapDispatch)(MemTransferDetailsEditDialogComponent);
