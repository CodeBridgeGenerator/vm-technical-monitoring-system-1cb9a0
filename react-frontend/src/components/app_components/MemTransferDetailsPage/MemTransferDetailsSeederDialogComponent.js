...
import seederData from "./memTransferDetails.seeder.json";
...
const MemTransferDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MemTransferDetailsSeederDialogComponent);
