...
import seederData from "./incomingUsedPartsQuotations.seeder.json";
...
const IncomingUsedPartsQuotationsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(IncomingUsedPartsQuotationsSeederDialogComponent);
