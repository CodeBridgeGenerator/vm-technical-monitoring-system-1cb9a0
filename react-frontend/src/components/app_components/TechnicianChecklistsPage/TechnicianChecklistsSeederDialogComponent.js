...
import seederData from "./technicianChecklists.seeder.json";
...
const TechnicianChecklistsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TechnicianChecklistsSeederDialogComponent);
