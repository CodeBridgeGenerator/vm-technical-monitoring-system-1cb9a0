...
import seederData from "./vmLists.seeder.json";
...
const VmListsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(VmListsSeederDialogComponent);
