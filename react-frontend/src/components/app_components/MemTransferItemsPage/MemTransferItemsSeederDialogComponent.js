...
import seederData from "./memTransferItems.seeder.json";
...
const MemTransferItemsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MemTransferItemsSeederDialogComponent);
