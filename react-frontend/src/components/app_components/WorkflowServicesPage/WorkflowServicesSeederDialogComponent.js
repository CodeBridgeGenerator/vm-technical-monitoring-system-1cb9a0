...
import seederData from "./workflowServices.seeder.json";
...
const WorkflowServicesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(WorkflowServicesSeederDialogComponent);
