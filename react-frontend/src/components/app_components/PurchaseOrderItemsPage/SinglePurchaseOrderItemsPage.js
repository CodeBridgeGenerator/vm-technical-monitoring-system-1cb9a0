...
const part = Array.isArray(res.part)
    ...
    const goBack = () => {
        navigate("/app/purchaseOrderItems");
    };
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">UnitPrice</label><p className="m-0 ml-3" >{Number(_entity?.unitPrice)}</p></div>
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Purchase Order</label>
