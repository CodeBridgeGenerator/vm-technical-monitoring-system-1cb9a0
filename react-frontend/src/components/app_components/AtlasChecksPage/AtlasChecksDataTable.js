...
const AtlasChecksDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
...
const dropdownTemplate0 = (rowData, { rowIndex }) => <p >{rowData.atlasCheckListId?.name}</p>
...
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.description}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="atlasCheckListId" header="AtlasCheckListId" body={dropdownTemplate0} filter={selectedFilterFields.includes("atlasCheckListId")} hidden={selectedHideFields?.includes("atlasCheckListId")}  style={{ minWidth: "8rem" }} />
...
<Column field="description" header="Description" body={pTemplate2} filter={selectedFilterFields.includes("description")} hidden={selectedHideFields?.includes("description")}  sortable style={{ minWidth: "8rem" }} />
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload AtlasChecks Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
      ...
      <Dialog header="Search AtlasChecks" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
...
export default AtlasChecksDataTable;