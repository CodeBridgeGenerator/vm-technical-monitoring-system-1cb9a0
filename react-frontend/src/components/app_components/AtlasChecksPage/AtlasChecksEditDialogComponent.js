...
const AtlasChecksEditDialogComponent = (props) => {
    ...
    const onSave = async () => {
        let _data = {
            atlasCheckListId: _entity?.atlasCheckListId?._id,
name: _entity?.name,
description: _entity?.description,
        ...
        await client.service("atlasChecks").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info atlasChecks updated successfully" });
    ...
    return (
        <Dialog header="Edit Atlas Checks" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="atlasChecks-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(AtlasChecksEditDialogComponent);
