...
import seederData from "./atlasChecks.seeder.json";
...
const AtlasChecksSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(AtlasChecksSeederDialogComponent);
