...
import seederData from "./irmsDeliveryOrders.seeder.json";
...
const IrmsDeliveryOrdersSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(IrmsDeliveryOrdersSeederDialogComponent);
