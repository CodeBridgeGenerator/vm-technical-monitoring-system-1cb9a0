...
import seederData from "./transferItems.seeder.json";
...
const TransferItemsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TransferItemsSeederDialogComponent);
