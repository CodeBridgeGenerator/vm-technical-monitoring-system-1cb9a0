...
const IrmsQuotationsEditDialogComponent = (props) => {
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="validDate" value={_entity?.validDate ? new Date(_entity?.validDate) : null} onChange={ (e) => setValByKey("validDate", new Date(e.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
...
export default connect(mapState, mapDispatch)(IrmsQuotationsEditDialogComponent);
