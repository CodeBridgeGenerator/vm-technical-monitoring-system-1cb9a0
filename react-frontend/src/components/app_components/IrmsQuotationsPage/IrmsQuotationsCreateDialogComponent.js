...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="validDate"  value={_entity?.validDate ? new Date(_entity?.validDate) : null} dateFormat="dd/mm/yy" onChange={ (e) => setValByKey("validDate", new Date(e.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
