...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Quotation Index</label><p className="m-0 ml-3" >{_entity?.quotationIndex}</p></div>
    ...
    <div className="col-12 mt-2">
        <TabView>
                    ...
                    <TabPanel header="Customer Purchase Orders" leftIcon="pi pi-building-columns mr-2">
                        <CustomerPurchaseOrdersPage/>
                    </TabPanel>
                    

                    <TabPanel header="Miscellaneous Charges" leftIcon="pi pi-building-columns mr-2">
                        <MiscellaneousChargesPage/>
                    </TabPanel>
                    

                    <TabPanel header="Waranty Period Details" leftIcon="pi pi-building-columns mr-2">
                        <WarantyPeriodDetailsPage/>
                    </TabPanel>
                    

                    <TabPanel header="Quotation Delivery Details" leftIcon="pi pi-building-columns mr-2">
                        <QuotationDeliveryDetailsPage/>
                    </TabPanel>
                    

                    <TabPanel header="Quotation Payement Details" leftIcon="pi pi-building-columns mr-2">
                        <QuotationPayementDetailsPage/>
                    </TabPanel>
                    

                    <TabPanel header="Incoming Used Parts Quotations" leftIcon="pi pi-building-columns mr-2">
