...
import seederData from "./irmsQuotations.seeder.json";
...
const IrmsQuotationsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(IrmsQuotationsSeederDialogComponent);
