...
import seederData from "./incomingMachineTickets.seeder.json";
...
const IncomingMachineTicketsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(IncomingMachineTicketsSeederDialogComponent);
