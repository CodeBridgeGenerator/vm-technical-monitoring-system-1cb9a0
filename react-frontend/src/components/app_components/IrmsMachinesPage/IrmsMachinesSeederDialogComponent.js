...
import seederData from "./irmsMachines.seeder.json";
...
const IrmsMachinesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(IrmsMachinesSeederDialogComponent);
