...
import seederData from "./warehouseMaster.seeder.json";
...
const WarehouseMasterSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(WarehouseMasterSeederDialogComponent);
