...
const SingleWarehouseMasterPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleWarehouseMasterId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleWarehouseMasterId]);


    const goBack = () => {
        navigate("/app/warehouseMaster");
    };
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">WarehouseMaster</h3>
                    <SplitButton
                ...
                {/* <p>warehouseMaster/{urlParams.singleWarehouseMasterId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Location</label><p className="m-0 ml-3" >{_entity?.location}</p></div>
    ...
    <div className="col-12 mt-2">
        <TabView>
                    ...
                    <TabPanel header="Stock In Details" leftIcon="pi pi-building-columns mr-2">
                        <StockInDetailsPage/>
                    </TabPanel>
                    ...
                    <TabPanel header="Irms Warehouse Parts" leftIcon="pi pi-building-columns mr-2">
                        <IrmsWarehousePartsPage/>
                    </TabPanel>
                    

                    <TabPanel header="Mem Warehouse Parts" leftIcon="pi pi-building-columns mr-2">
      ...
      <CommentsSection
        recordId={urlParams.singleWarehouseMasterId}
        user={props.user}
        alert={props.alert}
        serviceName="warehouseMaster"
      />
      <div
        id="rightsidebar"
...
export default connect(mapState, mapDispatch)(SingleWarehouseMasterPage);
