...
const ExternalTicketsEditDialogComponent = (props) => {
...
endTime: _entity?.endTime,
        ...
        await client.service("externalTickets").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info externalTickets updated successfully" });
    ...
    return (
        <Dialog header="Edit External Tickets" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="externalTickets-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(ExternalTicketsEditDialogComponent);
