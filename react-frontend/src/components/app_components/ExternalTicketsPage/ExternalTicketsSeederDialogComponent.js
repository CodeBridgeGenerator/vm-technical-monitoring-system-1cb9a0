...
import seederData from "./externalTickets.seeder.json";
...
const ExternalTicketsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ExternalTicketsSeederDialogComponent);
