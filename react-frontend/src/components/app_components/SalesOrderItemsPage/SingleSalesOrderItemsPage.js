...
const SingleSalesOrderItemsPage = (props) => {
...
const [part, setPart] = useState([]);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleSalesOrderItemsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
...
const part = Array.isArray(res.part)
        ...
        setPart(part);
            ...
            .catch((error) => {
                console.log({ error });
                props.alert({ title: "SalesOrderItems", type: "error", message: error.message || "Failed get salesOrderItems" });
            });
    }, [props,urlParams.singleSalesOrderItemsId]);


    const goBack = () => {
        navigate("/app/salesOrderItems");
    };
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Sales Order Items</h3>
                    <SplitButton
                ...
                {/* <p>salesOrderItems/{urlParams.singleSalesOrderItemsId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Part</label>
      ...
      <CommentsSection
        recordId={urlParams.singleSalesOrderItemsId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleSalesOrderItemsPage);
