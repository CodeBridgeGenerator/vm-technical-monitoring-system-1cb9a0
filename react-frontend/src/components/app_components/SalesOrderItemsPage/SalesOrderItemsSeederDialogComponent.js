...
import seederData from "./salesOrderItems.seeder.json";
...
const SalesOrderItemsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(SalesOrderItemsSeederDialogComponent);
