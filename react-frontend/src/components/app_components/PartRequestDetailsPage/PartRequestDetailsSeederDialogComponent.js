...
import seederData from "./partRequestDetails.seeder.json";
...
const PartRequestDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PartRequestDetailsSeederDialogComponent);
