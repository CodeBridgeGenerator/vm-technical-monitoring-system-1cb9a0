        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">CustomerDetails</h3>
                    <SplitButton
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Customer No</label><p className="m-0 ml-3" >{_entity?.customerNo}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Agent Name</label><p className="m-0 ml-3" >{_entity?.agentName}</p></div>
