...
const CustomerDetailsPage = (props) => {
    ...
    const filename = "customerDetails.csv";
  ...
  const onClickSaveHiddenfields = (ff) => {
    ...
    const deleteRow = async () => {
        try {
            ...
            console.log({ error });
            props.alert({ title: "CustomerDetails", type: "error", message: error.message || "Failed delete record" });
        }
    };
...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="customerDetails-add-button"/>
            ...
            <div className="grid align-items-center">
                <div className="col-11" role="customerDetails-datatable">
