...
import seederData from "./disposalItems.seeder.json";
...
const DisposalItemsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(DisposalItemsSeederDialogComponent);
