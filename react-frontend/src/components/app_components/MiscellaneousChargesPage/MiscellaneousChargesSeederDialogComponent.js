...
import seederData from "./miscellaneousCharges.seeder.json";
...
const MiscellaneousChargesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MiscellaneousChargesSeederDialogComponent);
