...
import seederData from "./incomingMachineChecklists.seeder.json";
...
const IncomingMachineChecklistsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(IncomingMachineChecklistsSeederDialogComponent);
