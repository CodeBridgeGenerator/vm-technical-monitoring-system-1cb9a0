...
const ExternalPartRequestsEditDialogComponent = (props) => {
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="requestedDate" value={_entity?.requestedDate ? new Date(_entity?.requestedDate) : null} onChange={ (e) => setValByKey("requestedDate", new Date(e.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="approvedDate" value={_entity?.approvedDate ? new Date(_entity?.approvedDate) : null} onChange={ (e) => setValByKey("approvedDate", new Date(e.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
...
export default connect(mapState, mapDispatch)(ExternalPartRequestsEditDialogComponent);
