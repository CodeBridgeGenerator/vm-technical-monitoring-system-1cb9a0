...
import seederData from "./externalPartRequests.seeder.json";
...
const ExternalPartRequestsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ExternalPartRequestsSeederDialogComponent);
