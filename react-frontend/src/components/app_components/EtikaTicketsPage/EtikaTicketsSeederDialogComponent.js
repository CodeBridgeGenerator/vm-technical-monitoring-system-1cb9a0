...
import seederData from "./etikaTickets.seeder.json";
...
const EtikaTicketsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(EtikaTicketsSeederDialogComponent);
