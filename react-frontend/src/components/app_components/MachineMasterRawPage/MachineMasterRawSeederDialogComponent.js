...
import seederData from "./machineMasterRaw.seeder.json";
...
const MachineMasterRawSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MachineMasterRawSeederDialogComponent);
