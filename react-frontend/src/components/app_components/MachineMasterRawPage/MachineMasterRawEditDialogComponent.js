...
const MachineMasterRawEditDialogComponent = (props) => {
...
commissionDate: _entity?.commissionDate,
        ...
        const result = await client.service("machineMasterRaw").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info machineMasterRaw updated successfully" });
    ...
    return (
        <Dialog header="Edit Machine Master Raw" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="machineMasterRaw-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(MachineMasterRawEditDialogComponent);
