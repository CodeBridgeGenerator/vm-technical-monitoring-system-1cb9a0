...
import seederData from "./memWarehouseParts.seeder.json";
...
const MemWarehousePartsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MemWarehousePartsSeederDialogComponent);
