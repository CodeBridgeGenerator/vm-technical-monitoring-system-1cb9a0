...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="purchaseOrderDate"  value={_entity?.purchaseOrderDate ? new Date(_entity?.purchaseOrderDate) : null} dateFormat="dd/mm/yy" onChange={ (e) => setValByKey("purchaseOrderDate", new Date(e.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="deliveryDate"  value={_entity?.deliveryDate ? new Date(_entity?.deliveryDate) : null} dateFormat="dd/mm/yy" onChange={ (e) => setValByKey("deliveryDate", new Date(e.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
