...
import seederData from "./customerPurchaseOrders.seeder.json";
...
const CustomerPurchaseOrdersSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CustomerPurchaseOrdersSeederDialogComponent);
