...
const SingleDisposalDetailsPage = (props) => {
...
const [partNumber, setPartNumber] = useState([]);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleDisposalDetailsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
...
const partNumber = Array.isArray(res.partNumber)
    ...
    }, [props,urlParams.singleDisposalDetailsId]);


    const goBack = () => {
        navigate("/app/disposalDetails");
    };
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Disposal Details</h3>
                    <SplitButton
                ...
                {/* <p>disposalDetails/{urlParams.singleDisposalDetailsId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Part Number</label>
    ...
    <div className="col-12 mt-2">
      ...
      <CommentsSection
        recordId={urlParams.singleDisposalDetailsId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleDisposalDetailsPage);
