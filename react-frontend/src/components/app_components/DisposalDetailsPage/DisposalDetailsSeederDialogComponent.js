...
import seederData from "./disposalDetails.seeder.json";
...
const DisposalDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(DisposalDetailsSeederDialogComponent);
