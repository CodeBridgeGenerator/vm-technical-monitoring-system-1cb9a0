...
const DocumentStoragesEditDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Edit DocumentStorages" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
