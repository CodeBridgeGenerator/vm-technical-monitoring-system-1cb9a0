...
import seederData from "./memStockInDetails.seeder.json";
...
const MemStockInDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MemStockInDetailsSeederDialogComponent);
