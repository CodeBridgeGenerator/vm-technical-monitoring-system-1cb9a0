...
import seederData from "./partsMasterRaw.seeder.json";
...
const PartsMasterRawSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PartsMasterRawSeederDialogComponent);
