...
import seederData from "./incomingMachineAbortHistory.seeder.json";
...
const IncomingMachineAbortHistorySeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(IncomingMachineAbortHistorySeederDialogComponent);
