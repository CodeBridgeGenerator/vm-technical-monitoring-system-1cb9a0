...
import seederData from "./transferDetails.seeder.json";
...
const TransferDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TransferDetailsSeederDialogComponent);
