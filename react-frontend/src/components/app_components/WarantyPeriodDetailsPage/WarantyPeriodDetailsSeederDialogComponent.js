...
import seederData from "./warantyPeriodDetails.seeder.json";
...
const WarantyPeriodDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(WarantyPeriodDetailsSeederDialogComponent);
