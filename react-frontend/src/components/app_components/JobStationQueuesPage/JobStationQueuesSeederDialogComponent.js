...
import seederData from "./jobStationQueues.seeder.json";
...
const JobStationQueuesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(JobStationQueuesSeederDialogComponent);
