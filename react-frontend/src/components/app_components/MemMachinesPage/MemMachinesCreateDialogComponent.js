...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="comissionDate"  value={_entity?.comissionDate ? new Date(_entity?.comissionDate) : null} dateFormat="dd/mm/yy" onChange={ (e) => setValByKey("comissionDate", new Date(e.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
