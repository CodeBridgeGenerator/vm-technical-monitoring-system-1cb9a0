...
const SingleMemMachinesPage = (props) => {
...
const [vendingMachineType, setVendingMachineType] = useState([]);
    ...
    useEffect(() => {
        ...
        client
            .service("memMachines")
            .get(urlParams.singleMemMachinesId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
...
const vendingMachineType = Array.isArray(res.vendingMachineType)
        ...
        setVendingMachineType(vendingMachineType);
            ...
            .catch((error) => {
                console.log({ error });
                props.alert({ title: "MemMachines", type: "error", message: error.message || "Failed get memMachines" });
            });
    }, [props,urlParams.singleMemMachinesId]);


    const goBack = () => {
        navigate("/app/memMachines");
    };
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">MEM Machines</h3>
                    <SplitButton
                ...
                {/* <p>memMachines/{urlParams.singleMemMachinesId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Vending Machine Type</label>
      ...
      <CommentsSection
        recordId={urlParams.singleMemMachinesId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleMemMachinesPage);
