...
import seederData from "./memMachines.seeder.json";
...
const MemMachinesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MemMachinesSeederDialogComponent);
