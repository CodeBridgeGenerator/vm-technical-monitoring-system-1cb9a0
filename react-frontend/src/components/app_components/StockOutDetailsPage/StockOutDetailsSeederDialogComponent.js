...
import seederData from "./stockOutDetails.seeder.json";
...
const StockOutDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(StockOutDetailsSeederDialogComponent);
