...
import seederData from "./locationMaster.seeder.json";
...
const LocationMasterSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(LocationMasterSeederDialogComponent);
