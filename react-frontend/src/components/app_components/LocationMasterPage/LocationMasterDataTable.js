...
const LocationMasterDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
...
const pTemplate5 = (rowData, { rowIndex }) => <p >{rowData.supervisor}</p>
...
<Column field="area" header="Area" body={pTemplate3} filter={selectedFilterFields.includes("area")} hidden={selectedHideFields?.includes("area")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="supervisor" header="Supervisor" body={pTemplate5} filter={selectedFilterFields.includes("supervisor")} hidden={selectedHideFields?.includes("supervisor")}  sortable style={{ minWidth: "8rem" }} />
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload LocationMaster Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
          serviceName="locationMaster"            
          onUploadComplete={() => {
            setShowUpload(false); // Close the dialog after upload
          }}/>
      </Dialog>

      <Dialog header="Search LocationMaster" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
