        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Location Master</h3>
                    <SplitButton
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Area</label><p className="m-0 ml-3" >{_entity?.area}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Supervisor</label><p className="m-0 ml-3" >{_entity?.supervisor}</p></div>
    ...
    <div className="col-12 mt-2">
        <TabView>
                    ...
                    <TabPanel header="Operation Centres" leftIcon="pi pi-building-columns mr-2">
      ...
      <CommentsSection
        recordId={urlParams.singleLocationMasterId}
        user={props.user}
        alert={props.alert}
