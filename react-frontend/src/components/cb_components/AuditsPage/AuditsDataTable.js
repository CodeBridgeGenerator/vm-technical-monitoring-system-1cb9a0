    ...
    return (
        <>
            ...
            >
                ...
                <Column field="serviceName" header="ServiceName" body={serviceNameTemplate} filter={selectedFilterFields.includes('serviceName')} hidden={selectedHideFields?.includes('serviceName')} sortable style={{ minWidth: '8rem' }} frozen />
                ...
                <Column field="method" header="Method" body={methodTemplate} filter={selectedFilterFields.includes('method')} hidden={selectedHideFields?.includes('method')} sortable style={{ minWidth: '8rem' }} />
                <Column field="details" header="Details" body={detailsTemplate} filter={selectedFilterFields.includes('details')} hidden={selectedHideFields?.includes('details')} sortable style={{ minWidth: '8rem' }} />
                {/* <Column
          field="createdBy"
          header="CreatedBy"
          body={pTemplate4}
