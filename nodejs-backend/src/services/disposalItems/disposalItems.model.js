    ...
    module.exports = function (app) {
        ...
        const schema = new Schema(
          {
            associatedNo: { type: Schema.Types.ObjectId, ref: "disposal_details", comment: "AssociatedNo, dropdown, false, true, true, true, true, true, true, disposalDetails, disposal_details, one-to-one, associatedNumber," },
