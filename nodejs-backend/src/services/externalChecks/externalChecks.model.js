    ...
    module.exports = function (app) {
        const modelName = "external_checks";
        const mongooseClient = app.get("mongooseClient");
        const { Schema } = mongooseClient;
        const schema = new Schema(
          {
            checkListId: { type: Schema.Types.ObjectId, ref: "external_checklists", comment: "Check List Id, dropdown, false, true, true, true, true, true, true, externalChecklists, external_checklists, one-to-one, name," },
