const { QontakWhatsappRecords } = require("./qontakWhatsappRecords.class");
const createModel = require("./qontakWhatsappRecords.model");
const hooks = require("./qontakWhatsappRecords.hooks");
...
module.exports = function (app) {
  ...
  app.use("/qontakWhatsappRecords", new QontakWhatsappRecords(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("qontakWhatsappRecords");

  // Get the schema of the collections 
  app.get("/qontakWhatsappRecordsSchema", function (request, response) {
