    ...
    module.exports = function (app) {
        const modelName = "disposal_details";
...
associatedNumber: { type:  String , required: true, comment: "Associated Number, p, false, true, true, true, true, true, true, , , , ," },
affectiveDate: { type: Date, comment: "Affective Date, p_calendar, false, true, true, true, true, true, true, , , , ," },
