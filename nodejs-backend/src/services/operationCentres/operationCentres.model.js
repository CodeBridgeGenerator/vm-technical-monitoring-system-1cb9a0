...
code: { type: Schema.Types.ObjectId, ref: "location_master", comment: "Code, dropdown, false, true, true, true, true, true, true, locationMaster, location_master, one-to-one, code," },
