    ...
    module.exports = function (app) {
        ...
        const schema = new Schema(
          {
            associatedNo: { type: Schema.Types.ObjectId, ref: "sample_details", comment: "Associated No, dropdown, false, true, true, true, true, true, true, sampleDetails, sample_details, one-to-one, associatedNumber," },
